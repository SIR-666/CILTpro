// GnrPerformanceInspectionTableD.jsx
...
// Template khusus LINE D (rapi seperti LINE A)
const defaultTemplateD = [
  // Tiap Jam
  { activity: "H2O2 Spray nozzle 1 (ml/min)", good: "2.00", reject: "<2.0", periode: "Tiap Jam", status: 1 },
  { activity: "H2O2 Spray nozzle 2 (ml/min)", good: "2.00", reject: "<2.0", periode: "Tiap Jam", status: 1 },
  { activity: "H2O2 Spray (MCCP 03) nozzle 3 (ml/min)", good: "2.00", reject: "<2.0", periode: "Tiap Jam", status: 1 },
  { activity: "H2O2 Spray (MCCP 03) nozzle 4 (ml/min)", good: "2.00", reject: "<2.0", periode: "Tiap Jam", status: 1 },
  { activity: "Flowrate", good: "2.00", reject: "<2.0", periode: "Tiap Jam", status: 1 },
  { activity: "Periode Pressure [mbar]", good: "750 - 950", reject: "<750 / >950", periode: "Tiap Jam", status: 1 },
  { activity: "Hepa pressure [mmmwg]", good: "10 - 25", reject: "<10 / >25", periode: "Tiap Jam", status: 1 },
  ...
  { activity: "Temp. secondary water (<C)", good: "17 - 24", reject: "<17 / >24", periode: "Tiap Jam", status: 1 },
  { activity: "Temp. Cooling Water (<C)", good: "≤ 4", reject: "> 4", periode: "Tiap Jam", status: 1 },
  { activity: "Press. Cooling Water (Bar)", good: "3 - 4", reject: "<3 / >4", periode: "Tiap Jam", status: 1 },
  { activity: "Temp. bottom seal (<C)", good: "410 - 430", reject: "<410 / >430", periode: "Tiap Jam", status: 1 },
  { activity: "Temp. top seal (<C)", good: "260 - 280", reject: "<260 / >280", periode: "Tiap Jam", status: 1 },
  { activity: "cap welding energy (J)", good: "130 - 170", reject: "<130 / >170", periode: "Tiap Jam", status: 1 },

  // 30 menit (sama struktur dengan LINE A)
  ...
  // Tambahan metrik output (per jam)
...
const GnrPerformanceInspectionTableD = ({
  ...
  const handleHourlySlotSelection = (slot) => {
    ...
    if (hasUnsavedData) saveDataBeforeSubmit();
