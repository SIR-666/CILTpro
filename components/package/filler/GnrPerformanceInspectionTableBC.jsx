...
// ===================== TEMPLATE KHUSUS LINE B & C =====================
// (Tetap pakai aktivitas & range BC; hanya flow/logic diseragamkan dengan LINE A)
...
// ===================== KOMPONEN =====================
const GnrPerformanceInspectionTableBC = ({
  ...
  // Activity tracking (matikan auto-pick saat user aktif)
  ...
  // ====== AUTO-SAVE (tiap 30 detik jika ada data terisi) ======
  useEffect(() => {
  ...
  // ====== FETCH MASTER + MERGE DENGAN TEMPLATE BC ======
  ...
  // ====== INPUT HANDLER (simpan per-slot + expiry sampai cutoff shift) ======
  ...
  // SINKRON KE PARENT: hanya lewat effect ini (aman)
  useEffect(() => {
